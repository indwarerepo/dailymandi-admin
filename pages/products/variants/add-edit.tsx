...
import { IAddProduct, ProductVariant } from '@/types/interfaces/product';
        ...
        <div>
            ...
            <div className="grid grid-cols-12 gap-3">
                <div className="col-span-12 sm:col-span-4">
                    ...
                    <h2 className="text-2xl tracking-tight mb-1 mt-1 font-poppins font-medium">Add Variant</h2>
                </div>
...
export default AddEditVariantIndex;
