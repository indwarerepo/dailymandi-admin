...
import { useGetAllProductCategorylistQuery } from '@/features/productCategory/productCategoryAPI';
import { Spinner } from '@/components/ui/spinner';
import DataTable from '@/components/ui-lib/data-table';
import { ProductCategory } from '@/types/interfaces/productCategory';
import { CategoryColumns } from '@/components/product-category/product-category';
import { getCookie } from 'cookies-next';
import { useAppSelector } from '@/store/hooks';

export default function ProductCategoryIndex({ className }: React.HTMLAttributes<HTMLDivElement>) {
    ...
    const { data, isLoading } = useGetAllProductCategorylistQuery(
        {
    ...
    const renderEmpty = () => {
        return <div>No Product Category Available!!!</div>;
    };
        ...
        <>
            ...
            <div className="grid grid-cols-12 gap-3">
                <div className="col-span-12 sm:col-span-4">
                    ...
                    <h2 className="text-2xl tracking-tight mb-1 mt-1 font-poppins font-medium">All Categories</h2>
                </div>
                <div className="col-span-12 sm:col-span-8">
                    <div className="flex justify-end flex-col sm:flex-row gap-4">
                        ...
                        <Button className="py-1 px-3" onClick={() => router.push('/product-category/add-edit')}>
            ...
            <DataTable
                ...
                data={(data?.data as ProductCategory[]) || []}
