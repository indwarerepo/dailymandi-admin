...
import { TaxColumns } from '@/components/tax/tax';
import { ITax } from '@/types/interfaces/tax';
import { useGetAllTaxlistQuery } from '@/features/tax/taxAPI';

export default function TaxIndex({ className }: React.HTMLAttributes<HTMLDivElement>) {
    const router = useRouter();
    const { pageIndex, pageSize, onPaginationChange, paginator } = usePagination();
    const { sorting, onSortingChange, field, order } = useSorting();
    const [columnFilters, setColumnFilters] = useState<ColumnFiltersState>([]);
    const debouncedColumnFilters: ColumnFiltersState = useDebounce(columnFilters, 1000);
    const { data, isLoading } = useGetAllTaxlistQuery(
        {
    ...
    console.log('🚀 ~ CMSIndex ~ data:', data);
    ...
    const renderEmpty = () => {
        return <div>No Tax Available!!!</div>;
    };
        ...
        <>
            ...
            <div className="grid grid-cols-12 gap-3">
                <div className="col-span-12 sm:col-span-4">
                    ...
                    <h2 className="text-2xl tracking-tight mb-1 mt-1 font-poppins font-medium">All Tax</h2>
                </div>
                <div className="col-span-12 sm:col-span-8">
                    <div className="flex justify-end flex-col sm:flex-row gap-4">
                        ...
                        <Button className="py-1 px-3" onClick={() => router.push('/tax/add-edit')}>
