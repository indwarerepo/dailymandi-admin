...
import { useGetAllCouponlistQuery } from '@/features/coupon/couponAPI';
import { CouponColumns } from '@/components/coupon/coupon';
import { getCookie } from 'cookies-next';
import { useAppSelector } from '@/store/hooks';

export default function CouponIndex({ className }: React.HTMLAttributes<HTMLDivElement>) {
    ...
    const { data, isLoading } = useGetAllCouponlistQuery(
        {
    ...
    // console.log('🚀 ~ CouponIndex ~ data:', data);
    ...
    const renderEmpty = () => {
        return <div>No Coupon Available!!!</div>;
    };
        ...
        <>
            ...
            <div className="grid grid-cols-12 gap-3">
                <div className="col-span-12 sm:col-span-4">
                    ...
                    <h2 className="text-2xl tracking-tight mb-1 mt-1 font-poppins font-medium">All Coupons</h2>
                </div>
                <div className="col-span-12 sm:col-span-8">
                    <div className="flex justify-end flex-col sm:flex-row gap-4">
                        ...
                        <Button className="py-1 px-3" onClick={() => router.push('/coupon/add-edit')}>
