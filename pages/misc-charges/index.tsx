...
import { DeliverySlotColumns, MiscChargesColumns } from '@/components/misc-charges/misc-charges';
import { IMiscCharges } from '@/types/interfaces/miscCharges';
import { useGetAllMiscChargeslistQuery } from '@/features/miscCharges/miscChargesAPI';
import DeliverySlotIndex from '@/components/misc-charges/delivery-slot/delivery-slot-index';

export default function MiscChargesIndex({ className }: React.HTMLAttributes<HTMLDivElement>) {
    ...
    const { data, isLoading } = useGetAllMiscChargeslistQuery(
        {
    ...
    // console.log('🚀 ~ MiscChargesIndex ~ data:', data);
    const emptyMessage = () => {
        if (isLoading) {
            return <Spinner />;
    ...
    const renderEmpty = () => {
        return <div>No Misc Charges Available!!!</div>;
    };
