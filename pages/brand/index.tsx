...
import { Search, BadgePlus, Filter, ExternalLink } from 'lucide-react';
import {
    Breadcrumb,
    BreadcrumbItem,
    BreadcrumbLink,
...
import { useGetAllBrandlistQuery } from '@/features/brand/brandAPI';
import { IBrand } from '@/types/interfaces/brand';
import { BrandColumns } from '@/components/setting/brand/brand';
import { getCookie } from 'cookies-next';
import { useAppSelector } from '@/store/hooks';

export default function BrandIndex({ className }: React.HTMLAttributes<HTMLDivElement>) {
    ...
    const { data, isLoading } = useGetAllBrandlistQuery(
        {
    ...
    const renderEmpty = () => {
        return <div>No Brand Available!!!</div>;
    };
        ...
        <>
            ...
            <div className="grid grid-cols-12 gap-3 pb-3">
                <div className="col-span-12 sm:col-span-4">
                    ...
                    <h2 className="text-2xl tracking-tight mb-1 mt-1 font-poppins font-medium">All Brand</h2>
                </div>
                <div className="col-span-12 sm:col-span-8">
                    <div className="flex justify-end flex-col sm:flex-row gap-4">
                        ...
                        <Button className="py-1 px-3" onClick={() => router.push('/brand/add-edit')}>
