...
import { useGetAllCMSlistQuery } from '@/features/cms/cmsAPI';
import { Spinner } from '@/components/ui/spinner';
import DataTable from '@/components/ui-lib/data-table';
import { CMSColumns } from '@/components/cms/cms';
import { ICMS } from '@/types/interfaces/cms';
import { getCookie } from 'cookies-next';
import { useAppSelector } from '@/store/hooks';

export default function CMSIndex({ className }: React.HTMLAttributes<HTMLDivElement>) {
    ...
    const { data, isLoading } = useGetAllCMSlistQuery(
        {
    ...
    const renderEmpty = () => {
        return <div>No CMS Available!!!</div>;
    };
        ...
        <>
            ...
            <div className="grid grid-cols-12 gap-3">
                <div className="col-span-12 sm:col-span-4">
                    ...
                    <h2 className="text-2xl tracking-tight mb-1 mt-1 font-poppins font-medium">All CMS</h2>
                </div>
