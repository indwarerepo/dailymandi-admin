import { Beat } from '@/components/setting/beat/beat';
                ...
                <div className="col-span-12 sm:col-span-8">
                    <div className="flex justify-end flex-col sm:flex-row gap-4">
                        <Button variant="outline" className="py-1 px-3">
                            <Upload className="mr-2 h-4 w-4" /> Export Products
                        </Button>
                        <Button variant="outline" className="py-1 px-3">
                            <MonitorUp className="mr-2 h-4 w-4" /> Import Products
                        </Button>
                        <Button className="py-1 px-3" onClick={() => router.push('/setting/beat/add-edit')}>
                            <BadgePlus className="mr-2 w-4 h-4" /> New Product
                        </Button>
                    </div>
                </div>
            </div>
