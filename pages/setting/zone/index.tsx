...
import { ZoneColumns } from '@/components/setting/zone/zone';
import { IZone } from '@/types/interfaces/zone';
import { useGetAllZonelistQuery } from '@/features/zone/zoneAPI';

export default function ZoneIndex({ className }: React.HTMLAttributes<HTMLDivElement>) {
    const router = useRouter();
    const { pageIndex, pageSize, onPaginationChange, paginator } = usePagination();
    const { sorting, onSortingChange, field, order } = useSorting();
    const [columnFilters, setColumnFilters] = useState<ColumnFiltersState>([]);
    const debouncedColumnFilters: ColumnFiltersState = useDebounce(columnFilters, 1000);
    const { data, isLoading } = useGetAllZonelistQuery(
        {
        ...
        <>
            ...
            <div className="grid grid-cols-12 gap-3">
                <div className="col-span-12 sm:col-span-4">
                    ...
                    <h2 className="text-2xl tracking-tight mb-1 mt-1 font-poppins font-medium">All Zone</h2>
                </div>
                <div className="col-span-12 sm:col-span-8">
                    <div className="flex justify-end flex-col sm:flex-row gap-4">
                        ...
                        <Button className="py-1 px-3" onClick={() => router.push('/setting/zone/add-edit')}>
