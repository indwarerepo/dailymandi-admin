...
export function UserForgetPassForm() {
            ...
            <form onSubmit={handleSubmit} className="relative">
                <Card className="border-0 shadow-none">
                    <CardHeader className="text-center">
                        <CardTitle className="mb-1">Forget Password</CardTitle>
                        <CardDescription>
                            Enter the email associated with your account and we will send email instruction to reset
                            your password.
                        </CardDescription>
                    </CardHeader>
                    ...
                    <CardFooter className="mb-6 flex-wrap">
                        ...
                        >
                            {isLoading ? (
                                ...
                                <p className="uppercase text-xs tracking-wide text-white font-raleway">Send Link</p>
                            )}
                        </Button>
                    </CardFooter>
